...
export default class Level12 extends Phaser.Scene {
    ...
    create() {
        ...
        nextlevel.on('pointerdown', () => this.scene.start('Level13'));
        previouslevel.setInteractive({ useHandCursor: true });
        previouslevel.on('pointerdown', () => this.scene.start('Level11'));
        ...
        this.add.text(500, 0, 'Level 12 ', { fontFamily: 'OCR A Std, monospace', fontSize: 50 });

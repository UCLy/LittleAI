...
export default class Level10 extends Phaser.Scene {
    ...
    create() {
        ...
        nextlevel.on('pointerdown', () => this.scene.start('Level11'));
        previouslevel.setInteractive({ useHandCursor: true });
        previouslevel.on('pointerdown', () => this.scene.start('Level9'));
        ...
        this.add.text(500, 0, 'Level 10 ', { fontFamily: 'OCR A Std, monospace', fontSize: 50 });

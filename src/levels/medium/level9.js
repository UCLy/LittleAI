...
export default class Level9 extends Phaser.Scene {
    ...
    create() {
        ...
        nextlevel.on('pointerdown', () => this.scene.start('Level10'));
        previouslevel.setInteractive({ useHandCursor: true });
        previouslevel.on('pointerdown', () => this.scene.start('Level8'));
        ...
        this.add.text(500, 0, 'Level 9 ', { fontFamily: 'OCR A Std, monospace', fontSize: 50 });

...
export default class Level5Scene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('triangle_vert', './game-icons/triangle_vert.png');
        this.load.image('triangle_jaune', './game-icons/triangle_jaune.png');
        this.load.image('triangle_rouge', './game-icons/triangle_rouge.png');
